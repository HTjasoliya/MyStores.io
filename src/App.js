    ...
    <>
      <div className="min-h-full">
                  ...
                  <div className="flex">
                    <div className="flex flex-shrink-0 items-center">
                      {/* <img
                        ...
                        alt="Your Company"
                      /> */}
                      <img width="48" height="48" src="https://img.icons8.com/fluency/48/small-business.png" alt="small-business"/>
                      <p className="font-semibold pl-2 text-[18px] text-slate-700">GetStores.io</p>
                      {/* <img
        ...
        <div className="py-8">
          <header>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-800 pl-3 bg-gray-200 h-12 flex items-center rounded-md">
                Stores Gallery
              </h1>
            </div>
          </header>
